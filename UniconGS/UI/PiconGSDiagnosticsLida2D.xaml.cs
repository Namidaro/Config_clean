...
namespace UniconGS.UI
{
    ...
    /// </summary>
    public partial class PiconGSDiagnosticsLida2D : UserControl, IUpdatableControl
    {
        #region Globals
        ...
        public PiconGSDiagnosticsLida2D()
        {
            InitializeComponent();
        }
        ...
        private void SetValue(ushort[] value)
        {
            ...
            this.SetDiscretes(discretModule1, discretModule2);
        }
        ...
        private void SetDiscretes(BitArray module1Value, BitArray module2Value)
        {
